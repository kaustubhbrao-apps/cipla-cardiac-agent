...
from cipla_cardiac_agent import (CardiacAgent, SIGNALS, ARCH_LABEL, CIPLA,
                                 M24, M26, Q24, Q26)
...
def main():
    ...
    data = dict(meta=meta, locks=locks, labels=ARCH_LABEL,
                signals=[dict(name=s.get("name"), space=s.get("space"),
